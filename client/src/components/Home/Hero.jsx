...
const Hero = () => {
  return (
    <section className="">
      <div className="grid w-full px-2 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-16 md:grid-cols-2 items-center justify-items-center border-2 border-dashed border-red-500">
        <div className="w-full flex flex-col border-2 border-dashed border-red-500">
